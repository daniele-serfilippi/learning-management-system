...
import { CompressorService } from 'src/app/shared/services/compressor.service';
...
export class AvatarComponent {
  ...
  pick(evt) {
    ...
    if (!isImage) {
      ...
      return this.notification.showError('Only images are allowed.');
    }
    ...
    this.compressorService.compress(file).subscribe(
      (file: File) => {
